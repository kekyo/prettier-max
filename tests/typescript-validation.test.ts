...
describe('TypeScript validation', () => {
  describe('with TypeScript errors', () => {
    it(
      'should detect TypeScript errors after formatting',
      async () => {
...
`
    ...
    it(
      'should fail build when failOnError is true',
      async () => {
        const testDir = await createTestDirectory(
          'typescript-validation',
          'fail-on-error'
...
`
    ...
    it(
      'should pass when no TypeScript errors',
      async () => {
        const testDir = await createTestDirectory(
          'typescript-validation',
          'no-errors'
...
`
    ...
    it(
      'should skip TypeScript validation when disabled',
      async () => {
        const testDir = await createTestDirectory(
          'typescript-validation',
          'disabled'
...
`
    ...
    it(
      'should preserve TypeScript error codes in output',
      async () => {
        const testDir = await createTestDirectory(
          'typescript-validation',
