...
const integrationTimeout = 120000;

describe('Deprecated symbol detection', () => {
  it(
    'should detect usage of @deprecated functions',
    async () => {
...
`
  ...
  it(
    'should detect usage of @deprecated classes and methods',
    async () => {
      const testDir = await createTestDirectory(
        'deprecated-detection',
        'deprecated-classes'
...
`
  ...
  it(
    'should detect deprecated usage with bracket notation',
    async () => {
      const testDir = await createTestDirectory(
        'deprecated-detection',
        'bracket-notation'
...
`
  ...
  it(
    'should detect deprecated usage in imports and exports',
    async () => {
      const testDir = await createTestDirectory(
        'deprecated-detection',
        'import-export'
...
`
  ...
  it(
    'should detect deprecated type references',
    async () => {
      const testDir = await createTestDirectory(
        'deprecated-detection',
        'type-references'
...
`
  ...
  it(
    'should not warn about deprecated usage within deprecated functions',
    async () => {
      const testDir = await createTestDirectory(
        'deprecated-detection',
...
`
  ...
  it(
    'should not warn about non-deprecated symbols',
    async () => {
      const testDir = await createTestDirectory(
        'deprecated-detection',
        'no-deprecated'
